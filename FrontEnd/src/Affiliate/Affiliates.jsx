...
export function Affiliates(){
    ...
    if(location.state.from == "affiliate"){
        console.log('from affiliate')
    }
    ...
    return (
        <div className='main'>
            ...
            <path d="M13,3V9H21V3M13,21H21V11H13M3,21H11V15H3M3,13H11V3H3V13Z" />
                ...
                <li ><Link to="/main/settings" state={{from: "affiliate"}}  href="#">Settings</Link></li>
            </ul>
                </div>
