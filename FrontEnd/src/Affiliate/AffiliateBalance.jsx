    ...
    return(
        ...
        <path d="M13,3V9H21V3M13,21H21V11H13M3,21H11V15H3M3,13H11V3H3V13Z" />
            ...
            <ul className="pod-links-stay">
                ...
                <li><Link to="/main/affiliate-links/transactions" href="#">Transactions</Link></li>
                <li><Link to="/main/affiliate-links/balance" onClick={(e) => e.preventDefault()} href="#">Balance</Link></li>
            </ul>
            </div>
