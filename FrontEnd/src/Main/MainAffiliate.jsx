    ...
    >
        ...
        Dashboard
                ...
                <ul className={podLinks}>
                    ...
                    <li><Link to="/main/affiliate-links/inactive" onClick={(e) =>{if(ShowSingleAffiliate != true){e.preventDefault()}}} href="#">Emails</Link></li>
                    <li><Link to="/main/affiliate-links/deleted" onClick={(e) =>{if(ShowSingleAffiliate != true){e.preventDefault()}}} href="#">Transactions</Link></li>
                    <li><Link to="/main/affiliate-links/active" onClick={(e) =>{if(ShowSingleAffiliate != true){e.preventDefault()}}} href="#">Balance</Link></li>
                </ul>
                </div>
